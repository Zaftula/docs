...
There are a few special tags you can add to the body of your Legacy Newsletters emails. These tags are case insensitive so if you make a mistake SendGrid knows what tags you want to use.
...
At SendGrid we are always trying to help our customers send email more efficiently. We recently did some research and attempted to provide some best practices when creating email custom tags. Below are some tests we ran to provide our customers custom tag benchmarks to consider when sending large volumes of marketing email.
